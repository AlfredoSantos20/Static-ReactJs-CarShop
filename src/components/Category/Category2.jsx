    ...
    <div className='py-8'>
       <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
              {/* Fourt col */}
              <div  className='col-span-2 py-10 pl-5 bg-gradient-to-br from-teal-500/90 to-teal-500/80
               text-white rounded-3xl relative h-[320px] flex items-end'>
                ...
                className='w-[300px] absolute top-1/2 -transalte-y-1/2  -right-0 
                lg:top-[20px] drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] '/>
              </div>
              {/* Fifth col */}
              <div  title='Caliper' className='py-10 pl-5 bg-gradient-to-br from-brandYellow/90 to-brandYellow/70
              text-white rounded-3xl relative h-[320px] flex items-end'>
                <div>
                  <div className='mb-4'>
              ...
              {/* Sixth col */}
              <div  title='Steering Wheel' className='py-10 pl-5 bg-gradient-to-br from-purple-500/90 to-purple-500/70
              text-white rounded-3xl relative h-[320px] flex items-end'>
                <div>
                  <div className='mb-4'>
                ...
                className='w-[180px] absolute drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] lg:top-[40px] right-0 '/>
              </div>
            </div>
        </div>
    </div>
